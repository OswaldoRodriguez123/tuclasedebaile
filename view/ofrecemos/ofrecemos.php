...
<section class="margin-top-40 padding-bottom-20">
   <div class="container">
    <div class="row"> 
		...
		<h3 class="padding-bottom-20">Características de la Academia</h3>
		    ...
		    <i class="icon_a-asistencia" style="font-size:50px"></i>
		    <p>Asistencia</p>	 
                </div>
            </div>
	    <div class="list-icon margin-right-30 text-center icono" >
                <div class="icono-inicio-p">
	            <i class="icon_a-eventos" style="font-size:50px"></i>
		    <p>Eventos</p>
                </div>
	    </div>
	    <div class="list-icon margin-right-30 text-center icono" >
                <div class="icono-inicio-p">
		    <i class="icon_a-clases-grupales" style="font-size:50px"></i>
		    <p>Grupales</p>
		</div>
            </div>
	    <div class="list-icon margin-right-30 text-center icono" >
                <div class="icono-inicio-p">
		    <i class="icon_a-clases-personalizadas" style="font-size:50px"></i>
                    <p><span class="hidden-xs">Clases</span> Personalizadas</p>
		</div>
            </div>
	    <div class="list-icon margin-right-30 text-center icono" >
                <div class="icono-inicio-p">
		    <i class="icon_a-tecnologia" style="font-size:50px"></i>
		    <p>Tecnología</p>
		</div>
            </div>
	    <div class="list-icon margin-right-30 text-center icono" >
	    ...
	    <div class="list-icon margin-right-30 text-center icono" >
                <div class="icono-inicio-p">
		    <i class="icon_a-certificados" style="font-size:50px"></i>
		    <p>Certificación</p>
		</div>
            </div>
        <div class="list-icon margin-right-30 text-center icono" >
                <div class="icono-inicio-p">
            <i class="icon_a-invitados-especiales" style="font-size:50px"></i>
...
<section class="fondo-clouds padding-top-bottom-50">
  ...
  <div class="row">
    ...
    <div class="col-md-4 padding-top-bottom-20 text-center ">
        ...
        <p>Ve más rápido con clases personalizadas, tu aprendizaje será más efectivo y aprovecharás de manera más precisa el conocimiento.</p> 
    </div>    
  </div>
  </div> 
</section>
...
<section class="padding-top-40 padding-bottom-40 fondo-gray">
   <div class="container">
       <div class="row">
           <div class="col-md-12">
               <h2 class="text-center">"HAZTE PARTE DE NUESTRO EQUIPO"</h2>
           </div>             
       </div>
   </div>
</section>
