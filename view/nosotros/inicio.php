...
<section class="fondo-clouds padding-top-bottom-50">
  <div class="container">
      <div class="row padding-20">
        ...
        <div class="col-sm-4 div_nosotros">
          <img src="img/nosotros/analicia.jpg" class="img-responsive imagen_nosotros">
        ...
        <div class="col-sm-4 div_nosotros">
          ...
          <span class="descripcion_nosotros descripcion_nosotros_rosado">
              ...
              <span class="padding-20">
                ...
                Es quien se encarga de manejar la recepción en la academia, sirve y orienta a nuestros clientes, además es instructora de los niños e instructora de clases personalizadas.  
              </span>
              <div class="social_nosotros">
        ...
        <div class="col-sm-4 div_nosotros">
          ...
          <span class="descripcion_nosotros descripcion_nosotros_rosado">
              <div class="clearfix padding-top-30"></div>
              <span class="padding-20">
                <b>Andrea Betancur - Productora de eventos</b><br><br>
        ...
        <div class="col-sm-4 div_nosotros">
          <img src="img/nosotros/oswaldo.jpg" class="img-responsive imagen_nosotros">
          <span class="descripcion_nosotros descripcion_nosotros_azul">
              <div class="clearfix padding-top-30"></div>
              <span class="padding-20">
                <b>Oswaldo Rodríguez – Desarrollador web -  Diseños e Interfaces</b><br><br>

                Es ingeniero en informática, encargado de todas las necesidades tecnológicas, como sistemas, páginas web y desarrollo en general, le brinda el toque de avanzada a la organización.
              </span>
              <div class="social_nosotros">
   ...
   <div class="container">
    <div class="row"> 
        <div class="col-md-12 padding-bottom-50">
            ...
            <p>En el año 2015 un grupo de profesionales y especialistas en el gremio del baile y gerencia, hemos decidido unirnos para crear la primera franquicia de altos estándares en el ecosistema del baile. Contamos con un equipo de trabajo altamente profesional que reúne entre todos muchos años de experiencia y calidad artística, con un nivel de conocimiento adecuado para brindar excelencia en nuestras diversas líneas de servicios. Rompemos con los protocolos y estándares tradicionales del aprendizaje monótono, para llegar a ofrecer experiencias positivas a todos nuestros alumnos en un ambiente cargado de mucho dinamismo, pero basado en la alegría como principio fundamental. Creemos fielmente que TU CLASE DE BAILE se convertirá en la franquicia del ecosistema del baile con mayor calidad en Latinoamérica.</p>   
    
        </div>
    </div>
   </div>
</section>
<section class="padding-top-30" style="display:none">
