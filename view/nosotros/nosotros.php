...
<section class="fondo-gray margin-top-70">
...
<section class="fondo-clouds">
        <div class="container padding-top-bottom-10">
            <h3 class="text-center text-uppercase">Si nuestro equipo lo piensa, lo hace posible</h3> 
        </div>
</section> 
    ...
    <div class="row">
        <div id="ancho-41" class="col-md-5 text-center vcenter padding-top-10">            
            ...
            <p class="padding-bottom-20">
                Desde el año 2012 inició  la idea de crear un software
				que diera soluciones a los problemas cotidianos, que enfrentamos todos aquellos
				que laboramos en el medio artístico, especialmente en las academias de  baile,
				y paso a paso fuimos fundamentando una herramienta que se ajustará a las necesidades académicas,
				apoyados con las experiencias vividas en el entorno del  creador de la aplicación, Robert Virona. Fundador de EASY DANCE

            </p>
            
            <p>
                El equipo aprovechó alianzas con diversas academias para realizar  un riguroso
				BENCHMARKING (Estudio de Mercadeo) tanto nacional como internacional  para entender
				el sistema laboral de cada una  estas instituciones dancísticas  y  poder así adaptarse 
				a  su entorno y  estilo, de esta forma se fue originando un proyecto que se ajusta a 
				las necesidades de cualquier organización de baile. 
            </p>
        </div> 
        <div class="col-md-7 vcenter padding-top-10">
            <img class="img-responsive w100" src="img/nosotros-1.png">
        </div>       
    </div>       
   </div>
</section>  
<section class="padding-top-bottom-50">
   <div class="container">
    <div class="row"> 
        <div class="col-md-7 vcenter padding-top-10">
            <div class="col-md-4"><img src="img/iconos/dolares.png" class="img-responsive img-center padding-bottom-30" width="150" ></div>
			<div class="col-md-4"><img src="img/iconos/dolares.png" class="img-responsive img-center padding-bottom-30" width="150" ></div>
			<div class="col-md-4"><img src="img/iconos/dolares.png" class="img-responsive img-center padding-bottom-30" width="150" ></div>
			<div class="col-md-4"><img src="img/iconos/dolares.png" class="img-responsive img-center padding-bottom-30" width="150" ></div>
			<div class="col-md-4"><img src="img/iconos/dolares.png" class="img-responsive img-center padding-bottom-30" width="150" ></div>
