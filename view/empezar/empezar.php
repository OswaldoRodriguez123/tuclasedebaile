  ...
  <div class="row">
    <h3 class="text-center">CASOS DE ÉXITO</h3>  
     ...
     <div class="col-md-4 padding-top-bottom-20 text-center">
        <img src="img/caso-4.jpg" class="img-circle img-responsive img-center img-150" alt="" >
        <h4>ANDREA MARULANDA</h4>                    
        <blockquote> <span style="font-size:35px">“</span> &nbsp; Contar con profesores de talla internacional, que ademas están capacitados y cuentan con todas las herramientas para ayudar a los estudiantes a mejorar en su proceso formativo es maravilloso.</blockquote>
    </div>
    <div class="col-md-4 padding-top-bottom-20 text-center">
