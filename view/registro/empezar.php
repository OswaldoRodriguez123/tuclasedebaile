...
<!--     <section class="margin-top-100">
    ...
    <section class="banner_arriba_registro">
    <div class="container">
<!--     <div class="row">  -->

        <div class="col-xs-12 hidden-lg hidden-md"><img class="img-responsive registro_arriba" src="img/imagenes_nuevas/registro_arriba.jpg"></div>
                ...
                <form name="MyForm" id="MyForm" role="form" >
                    ...
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                            ...
                            <div class="col-sm-12" style="padding-top:10px">
                               ...
                               <br>
                                ...
                                <div class="col-sm-12">
                                 <div class="form-group">
                                    <div class="fg-line">
                                    <input type="text" class="form-control input-sm" name="codigo" id="codigo" placeholder="Ingresa el código" ng-model="formInfo.Codigo"/>
                                    </div>
                                 </div>
                                    <span ng-show="codigoRequired">{{codigoRequired}}</span>
                               </div>
                            ...
                            <br><br>
                               ...
                               <button type="button" ng-show="enviando" class="btn btn-blanco-grande text-uppercase m-r-10 f-22 guardar" id="guardar" name ="guardar" ng-click="saveRegistro()">Llévame</button>
